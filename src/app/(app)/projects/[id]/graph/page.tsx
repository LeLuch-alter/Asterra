...
export default async function GraphPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="grid gap-4">
      <div>
        <p className="eyebrow eyebrow-accent mb-1">{t("Research graph")}</p>
        <p className="max-w-2xl text-sm text-muted-foreground">
          {t("The map of this research: what it asks, how it is tested, who contributes, which sources support which part, and where the idea branched.")}
        </p>
      </div>
