...
export default async function TimelinePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <div className="mb-6">
        <p className="eyebrow eyebrow-accent mb-1">{t("Research timeline")}</p>
        <p className="text-sm text-muted-foreground">
          {t("How this research developed: people joining, ideas changing, experiments and results appearing.")}
        </p>
      </div>
